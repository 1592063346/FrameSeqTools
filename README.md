...
!!! hint <font size=4>`forced_merge`</font>

    以硬过渡形式，直接合并两个帧序列片段。

    案例见 `example/1/forced.mp4`。

!!! hint <font size=4>`gradual_transition_merge`</font>
...
!!! hint <font size=4>`push_transition_merge`</font>
...
!!! hint <font size=4>`wipe_transition_merge`</font>
...
!!! hint <font size=4>`frame_crop_split`</font>
...
!!! hint <font size=4>`frame_darken`</font>
...
!!! hint <font size=4>`frame_glare`</font>
...
!!! hint <font size=4>`frame_extract`</font>
...
!!! hint <font size=4>`frame_crop`</font>
